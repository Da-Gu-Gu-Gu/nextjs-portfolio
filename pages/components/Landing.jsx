  ...
  return (
    ...
    <div className='text-3xl  w-screen h-screen flex flex-col   justify-center'>
        ...
        <div   className='self-center sm:w-96  w-80 mt-8 flex flex-col'>
          <h2 onClick={()=>alert('arr')} className='bg-white hi p-1  translate-y-[110%] px-2 rounded-lg inline self-start '>👋 Hi</h2>
          <h2  className='bg-white hi   p-1 px-2 translate-y-[110%] rounded-lg mt-2 inline self-start '>I'm Da Gu Gu Gu</h2>
          <h2  className='bg-white hi   p-1 px-2 translate-y-[110%] rounded-lg mt-2 inline self-start '>Web Developer</h2>
       </div>
    </div>
